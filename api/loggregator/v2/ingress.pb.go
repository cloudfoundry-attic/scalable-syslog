...
func init() {
	proto.RegisterType((*IngressResponse)(nil), "loggregator.IngressResponse")
}
...
func (c *ingressClient) Sender(ctx context.Context, opts ...grpc.CallOption) (Ingress_SenderClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Ingress_serviceDesc.Streams[0], c.cc, "/loggregator.Ingress/Sender", opts...)
	if err != nil {
		return nil, err
	}
...
var _Ingress_serviceDesc = grpc.ServiceDesc{
	ServiceName: "loggregator.Ingress",
...
var fileDescriptor2 = []byte{
	...
	0x4a, 0x2d, 0x2e, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xce, 0xc9, 0x4f, 0x4f, 0x2f,
	0x4a, 0x4d, 0x4f, 0x2c, 0xc9, 0x2f, 0x92, 0xe2, 0x4b, 0xcd, 0x2b, 0x4b, 0xcd, 0xc9, 0x2f, 0x48,
	0x85, 0x48, 0x2a, 0x09, 0x72, 0xf1, 0x7b, 0x42, 0x54, 0x07, 0xa5, 0x16, 0x17, 0xe4, 0xe7, 0x15,
	0xa7, 0x1a, 0xf9, 0x70, 0xb1, 0x43, 0x85, 0x84, 0x1c, 0xb9, 0xd8, 0x82, 0x53, 0xf3, 0x52, 0x52,
	0x8b, 0x84, 0x44, 0xf5, 0x90, 0x4c, 0xd1, 0x73, 0x85, 0x1a, 0x22, 0x25, 0x83, 0x22, 0x8c, 0x66,
	0x92, 0x12, 0x83, 0x06, 0x63, 0x12, 0x1b, 0xd8, 0x1e, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff,
	0xd6, 0xa8, 0x28, 0xe3, 0x95, 0x00, 0x00, 0x00,
}
